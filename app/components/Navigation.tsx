                    ...
                    <div className="flex items-center py-1.5">
                        <div className="flex items-center space-x-1">
                            {servicesCategories.map((category) => {
                                ...
                                const isSampleCategory = category.id === "sample";
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            {/* Conditionally render ChevronDown only if it's not the "sample" category */}
                                            {!isSampleCategory && (
                                                <ChevronDown className="ml-1 h-2.5 w-2.5 transition-transform duration-200 group-hover:rotate-180 flex-shrink-0 text-white" />
                                            )}
                                        </Link>

                                        {/* Conditionally render dropdown only if it's not the "sample" category */}
                                        {!isSampleCategory && (
                                            <div
